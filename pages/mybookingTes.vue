<template>
  <NuxtLayout name="menu">
    ...
    <el-dialog v-model="dialogVisible1" title="提示" width="500">
      ...
      <template #footer>
        <div class="dialog-footer">
          <el-button @click="feedbackDialogVisible1 = false">取消</el-button>
    ...
    <!-- 撤回页面 -->
    <el-dialog v-model="dialogVisible2" title="提示" width="500">
      <span>是否要撤回该预约？</span>
      <template #footer>
        <div class="dialog-footer">
          <el-button @click="feedbackDialogVisible2 = false">取消</el-button>
...
const feedbackDialogVisible2 = ref(false);
